...
public class MyRoomsViewController extends ViewController
{
  ...
  @FXML private TableView<MyRoomsViewModel> roomsTable;
  @FXML private TableColumn<MyRoomsViewModel,String> roomId;
  @FXML private TableColumn<MyRoomsViewModel,String> bedrooms;
  @FXML private TableColumn<MyRoomsViewModel,String> price;
  @FXML private TableColumn<MyRoomsViewModel,String> address;
  @FXML private TableColumn<MyRoomsViewModel, Boolean> reserved;
